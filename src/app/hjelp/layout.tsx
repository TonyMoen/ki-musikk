...
export const metadata: Metadata = {
  title: 'Hjelp og FAQ - AI MUSIKK',
  description: 'Finn svar på vanlige spørsmål om AI MUSIKK. Lær hvordan du lager sanger, kjøper kreditter, og får mest ut av tjenesten.',
}
