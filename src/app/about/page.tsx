...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      <h1 className="text-4xl font-bold mb-6">Om Musikkfabrikken</h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-xl text-muted-foreground mb-8">
          Musikkfabrikken er Norges første AI-drevne plattform for å lage personlige sanger
        ...
        <div className="grid gap-8 md:grid-cols-2 my-12">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Musikkfabrikken er utviklet av norske musikk- og teknologientusiaster som
