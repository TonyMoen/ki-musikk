            ...
            >
              <div
                className={cn(
                  ...
                  isCurrent && 'bg-[#F26522] text-[var(--ink)] shadow-lg shadow-[#F26522]/25',
                  isCompleted && 'border-2 border-[#F26522] text-[#F26522] group-hover:bg-[#F26522]/10',
                  isFuture && 'border-2 border-[var(--border-soft)] text-[var(--ink-2)]'
                )}
              >
                {isCompleted ? (
              ...
              <span
                className={cn(
                  ...
                  isCurrent && 'text-[var(--ink)]',
                  isCompleted && 'text-[#F26522]',
                  isFuture && 'text-[var(--ink-2)]'
                )}
              >
                {step.label}
              </span>
            ...
            {index < STEPS.length - 1 && (
              <div
                className={cn(
                  ...
                  step.number < currentStep ? 'bg-[#F26522]' : 'bg-[var(--border-soft)]'
                )}
              />
            )}
          </div>
